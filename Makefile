...
push-dev:
	...
	@docker tag deltaio/delta-sharing-server:$(SERVER_VERSION) gcr.io/zing-dev-197522/delta-sharing-server:$(IMAGE_TAG)
	@docker push gcr.io/zing-dev-197522/delta-sharing-server:$(IMAGE_TAG)
